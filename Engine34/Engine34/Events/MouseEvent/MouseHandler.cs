...
{
    //1- Define a delegate
    public class MouseHandler : IUpdService
    {
        ...
        protected virtual void OnMouseScrollUp(MouseState m)
        {
            ...
            {
                MouseScrollUp(this, new MouseEventArgs()
                {
                    mouseState = m
                });
            }
        ...
        protected virtual void OnMouseScrollDown(MouseState m)
        {
            ...
            {
                MouseScrollDown(this, new MouseEventArgs()
                {
                    mouseState = m
                });
            }
        ...
        protected virtual void OnMouseReleased(MouseState m)
        {
            ...
            {
                MouseReleased(this, new MouseEventArgs()
                {
                    mouseState = m
                });
            }
        ...
        protected virtual void OnMouseMoved(MouseState m)
        {
            if (MouseMoved != null)
            {
                MouseMoved(this, new MouseEventArgs()
                {
                    mouseState = m
                });
            }
